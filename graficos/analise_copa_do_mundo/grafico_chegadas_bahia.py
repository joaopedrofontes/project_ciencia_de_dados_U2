...
#Gráfico comparando as chegadas por mês, na Bahia, durante o período da copa do mundo
...
datas_completas = pd.date_range(start='2013-01-01', end='2015-12-01', freq='MS')  # MS = Month Start
...
plt.plot(df_final['data'], df_final['chegadas'], marker='o', color='seagreen')
plt.title('Chegadas de Estrangeiros na Bahia (2013–2015)', fontsize=14)
